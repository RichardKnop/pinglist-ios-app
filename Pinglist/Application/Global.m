...
+ (AFHTTPRequestOperationManager *)afManager {
    ...
    [manager.requestSerializer setValue:[NSString stringWithFormat:@"Bearer %@", [Global sharedInstance].accessToken] forHTTPHeaderField:@"Authorization"];
...
+ (void)showAlert :(NSString *)body sender :(id)sender{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:nil message:body preferredStyle:UIAlertControllerStyleAlert];
