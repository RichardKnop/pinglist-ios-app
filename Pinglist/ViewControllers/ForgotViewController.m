...
- (IBAction)onSubmit:(id)sender {
    ...
    NSString *requestURL    =   [NSString stringWithFormat:@"%@/v1/accounts/password-reset", endpointURL];
    ...
    [manager POST:requestURL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        [SVProgressHUD showSuccessWithStatus:@"Email sent. Check your inbox for further instructions."];
        [self.navigationController popViewControllerAnimated:YES];
