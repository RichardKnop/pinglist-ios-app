...
- (void)commonInit {
    ...
    _colorTop = [UIColor clearColor];//[UIColor colorWithRed:0 green:122.0/255.0 blue:255/255 alpha:1];
    _colorLine = [UIColor colorWithRed:184/255.0f green:233/255.0f blue:134/255.0f alpha:1.0f];//[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1];
    _colorBottom = [UIColor clearColor];//[UIColor colorWithRed:0 green:122.0/255.0 blue:255/255 alpha:1];
    _colorPoint = [UIColor clearColor];//[UIColor colorWithWhite:1.0 alpha:0.7];
    _colorTouchInputLine = [UIColor clearColor];//[UIColor grayColor];
