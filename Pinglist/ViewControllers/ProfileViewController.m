...
- (void)getMe {
  ...
  NSString *requestURL =
      [NSString stringWithFormat:@"%@/v1/accounts/me", endpointURL];
...
- (void)viewDidLoad {
  ...
  self.txtFieldFirstname.font =
      [UIFont fontWithName:@"Lato-Regular" size:15.0f];
...
- (IBAction)onWebSite:(id)sender {
  [[UIApplication sharedApplication]
      openURL:[NSURL URLWithString:@"https://pingli.st/"]];
}
