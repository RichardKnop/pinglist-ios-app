...
- (void)viewDidLoad {
  ...
  [Global changePlaceholderTextColor:self.txtFieldOld
                                text:@"Old password"
                               color:GREEN_COLOR];
  [Global changePlaceholderTextColor:self.txtFieldNew
                                text:@"New password"
                               color:GREEN_COLOR];
  [Global changePlaceholderTextColor:self.txtFieldConfirm
...
- (IBAction)onChange:(id)sender {
  ...
  if ([self.txtFieldConfirm.text isEqualToString:@""] ||
      [self.txtFieldNew.text isEqualToString:@""]) {
  ...
  NSString *requestURL = [NSString
      stringWithFormat:@"%@/v1/accounts/users/%d", endpointURL, self.myUserId];
  NSDictionary *params = @{
    @"password" : self.txtFieldOld.text,
