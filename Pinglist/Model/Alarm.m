...
- (id)initWithData :(NSDictionary *)dict {
    ...
    self.expected_http_code     =   [[dict safe_objectForKey:@"expected_http_code"] intValue];
    self.max_response_time      =   [[dict safe_objectForKey:@"max_response_time"] intValue];
    self.interval               =   [[dict safe_objectForKey:@"interval"] intValue];
    self.isEmailAlert           =   [[dict safe_objectForKey:@"email_alerts"] boolValue];
    self.isPushNotification     =   [[dict safe_objectForKey:@"push_notification_alerts"] boolValue];
